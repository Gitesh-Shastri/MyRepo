...
public class SubCategoryArrayAdapter extends RecyclerView.Adapter<SubCategoryArrayAdapter.ViewHolder>{
    ...
    public SubCategoryArrayAdapter(ArrayList<SubCategory> subCategories, Context mContext) {
